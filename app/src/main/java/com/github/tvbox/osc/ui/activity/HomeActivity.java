                ...
                ApiConfig.get().loadJar(useCacheConfig, ApiConfig.get().getSpider(), new ApiConfig.LoadConfigCallback() {
                    ...
                    public void success() {
                        ...
                        mHandler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                if (!useCacheConfig)
                                    Toast.makeText(HomeActivity.this, "会员链接加载成功！", Toast.LENGTH_SHORT).show();
                                initData();
                            }
                        }, 50);
                    }
                    ...
                    public void error(String msg) {
                        ...
                        mHandler.post(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(HomeActivity.this, "VIP会员链接已过期，请联系客服续费QQ408220310", Toast.LENGTH_SHORT).show();
                                initData();
                            }
                        });
                    }
